...
def go(args):
    ...
    mlflow.sklearn.save_model(
        sk_pipe,  # The model/pipeline to save
        "random_forest_dir",  # Directory where model will be saved 
        input_example=X_train.iloc[:5]  # Example of input data for model signature
    )
    ######################################
